...
public sealed class UpdateGoodsReceiptDtoValidator : AbstractValidator<UpdateGoodsReceiptDto>
{
    ...
    private async Task ValidateModeAsync(UpdateGoodsReceiptDto dto, ValidationContext<UpdateGoodsReceiptDto> ctx, CancellationToken ct)
    {
