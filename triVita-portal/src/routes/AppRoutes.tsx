  ...
  return (
    <Routes>
      ...
      >
        ...
        />
        <Route
          path="pharmacy/masters/customer"
          element={
            <RequirePermission permission={TriVitaPermissions.PharmacyApi}>
              <Lazy.PharmacyMasterCustomerView />
            </RequirePermission>
          }
        />
        <Route
        ...
        />
        <Route
          path="pharmacy/transactions/purchase-bill"
          element={
            <RequirePermission permission={TriVitaPermissions.PharmacyApi}>
              <Lazy.PharmacyPurchaseBillView />
            </RequirePermission>
          }
        />
        <Route
          path="pharmacy/transactions/sales-bill"
          element={
            <RequirePermission permission={TriVitaPermissions.PharmacyApi}>
              <Lazy.PharmacySalesBillView />
            </RequirePermission>
          }
        />
        <Route
          path="pharmacy/transactions/stock-adjustment"
          element={
            <RequirePermission permission={TriVitaPermissions.PharmacyApi}>
              <Lazy.PharmacyStockAdjustmentView />
            </RequirePermission>
          }
        />
        <Route
